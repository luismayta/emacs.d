...
There are a lot of different ways to contribute to Emacs. See below for
...
first. And note that all participation in the Emacs community
...
the Emacs project, how Emacs is architected, how to make changes to
modules, and so on.
