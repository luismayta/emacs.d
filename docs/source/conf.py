...
plantuml = "java -jar " + os.path.join(ROOT_PATH, "../../extras/jar/plantuml.jar",)
...
latex_documents = [
    (master_doc, "Emacs.tex", "Emacs Documentation", "Emacs (Luis Mayta)", "manual",),
]
...
man_pages = [
    (master_doc, "emacs", "Emacs Documentation", [author], 1,),
]
