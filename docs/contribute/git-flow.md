...
To contribute to emacs.d project on [GitHub](https://github.com/luismayta/emacs.d), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/emacs.d/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to emacs.d project on Gitlab:
...
```bash
git remote add upstream  https://github.com/luismayta/emacs.d.git
```

Now your **upstream** points to **luismayta/emacs.d**.
...
git fetch upstream # assuming upstream is luismayta/emacs.d
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/emacs.d/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
